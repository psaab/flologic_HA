...
T.test("cloud: version, link pin, updater asset, no picker (CLOUD-U6)", function()
  T.check_equal(FLOCLOUD_DRIVER_VERSION, "2026090807", "cloud version")
  ...
  local body = JSON.encode({
    {
      tag_name = "c4-v2026090807",
      draft = false,
      prerelease = false,
      assets = {
        {
          name = "flologic_cloud.c4z",
          browser_download_url = "https://github.com/psaab/flologic_HA/releases/download/c4-v2026090807/flologic_cloud.c4z",
        },
      },
    },
    {
      ...
      assets = {
        {
          ...
          browser_download_url = "https://github.com/psaab/flologic_HA/releases/download/c4-v2026090807/flologic_valve.c4z",
        },
      },
    },
  })
  ...
  T.check_equal(release.version, "2026090807", "cloud release version")
