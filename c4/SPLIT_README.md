...
Both drivers share lockstep version **2026090805** (link protocol
version **1**). Releases ship both packages under one `c4-v*` tag (e.g.
`c4-v2026090805`); see [c4/RELEASE_NOTES.md](RELEASE_NOTES.md).
...
- **Version mismatch.** Both drivers must run the same lockstep
  version (currently 2026090805; the release tag must equal both
